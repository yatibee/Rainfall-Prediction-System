...
% ---------- Title Info ----------
\title[Weather Forecasting]{Weather Forecasting Using Historical Data Analysis}
...
\titlegraphic{\includegraphics[height=1.8cm]{images/bu_logo.png}}
\date{}
...
\begin{frame}[noframenumbering]
  ...
  \begin{beamercolorbox}[sep=8pt,center,rounded=true]{title}
    {\Large\bfseries Weather Forecasting Using Historical Data Analysis}\\[0.3em]
